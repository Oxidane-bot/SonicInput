...
- **Reproducible Windows releases**: official builds are pinned to the VS 2022 C++ x64 toolchain on `windows-2022`, explicitly initialize that environment, and complete a minimal Nuitka compile before the full package, Sherpa DLL SHA-256 audit, and smoke suite.
...
## Quick Start
1. Download `SonicInput-v0.8.6-win64.exe` from [Releases](https://github.com/Oxidane-bot/SonicInput/releases)
