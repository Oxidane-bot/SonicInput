...
ZH_CN: dict[str, str] = {
    ...
    "review_job_summary": "{records} 条记录，{suggestions} 条候选",
    ...
    "lexicon_memory_help": "已接受的本地词汇会在 AI 清理时作为发音相近的纠错提示使用；只有当前文本命中同音或近音片段时才会注入。",
    "clear_lexicon": "清空词汇记忆",
    "clear_learning_data": "清空词汇学习数据",
    "clear_learning_data_success": "已清空词汇学习数据。",
    "clear_learning_data_failed": "清空词汇学习数据失败。",
