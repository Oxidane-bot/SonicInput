...
class TranscriptionService(LifecycleComponent, ISpeechService):
    """重构后的转录服务（支持配置热重载）
    ...
    def _do_stop(self) -> bool:
        ...
        with self._service_lock:
            try:
                ...
                app_logger.audio("TranscriptionService stopped", {})
