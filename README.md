...
- **可复现发布**：Windows 正式发布统一使用已验证的 MSVC Nuitka 路径，保留 Sherpa ONNX Runtime DLL 的 SHA-256 审计；打包冒烟失败时会保留子进程输出，便于直接定位运行时问题。
...
## 快速开始
1. 从 [Releases](https://github.com/Oxidane-bot/SonicInput/releases) 下载 `SonicInput-v0.8.5-win64.exe`
